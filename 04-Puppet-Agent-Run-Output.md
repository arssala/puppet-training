Voici la sortie de la Puppet initiale exécutée sur la VM **agent** ...
```
...
Retour à **Lab #4** --> [Install Puppet Agent](04-Install-Puppet-Agent.md#run-the-puppet-agent-again)

---

Continuer vers **Lab #5** --> [Puppet config files, and puppet code, and CLI](05-Puppet-Config-and-Code.md#lab-5)
